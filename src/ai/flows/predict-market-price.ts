...
const PredictMarketPriceOutputSchema = z.object({
  predictedPriceRange: z
    .string()
    .describe('The predicted price range, e.g., "Rs.40 - Rs.45 / kg".'),
  trend: z
    .string()
...
For the given crop, generate a realistic but randomized predicted price range in Rupees per kg suitable for the Tamil Nadu market. Use "Rs." as the currency symbol (e.g., "Rs.40 - Rs.45 / kg").
